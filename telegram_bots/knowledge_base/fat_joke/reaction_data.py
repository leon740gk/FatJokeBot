...
volodymyr_rules = [
    ...
    "5 заповідей Володі. Заповідь 5. У Володи андроид и это беспокоит...(с)",
]

text_to_text_reactions = {
    ("сірожа", "серий", "сергій", "сіроня", "сережа", "серега", "серёга"): sergios_rules,
    ("вова", "володя"): volodymyr_rules,
    ("валодя",): "У Володи андроид и это беспокоит...(с)",
    ("влад", "slave"): "What is love? Baby don't hurt me!",
    ("кабачок",): "Кабачок, вже не YappyDoor! Він - кабачковий амбассадор!",
